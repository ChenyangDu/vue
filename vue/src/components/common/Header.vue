  ...
  <div class="header">
    ...
    <div class="header-right">
      ...
      <div v-if="isLogin">
        ...
        <el-tooltip effect="light" :content="notread?`有${notread}条未读消息`:`消息中心`" placement="bottom">
          <div class="btn-bell">
  ...
  methods: {
    ...
    handleCommand(command) {
      ...
      if (command == "loginout") {
        ...
        this.$router.push({
          name: "DashBoard",
          params: { user_id: this.$store.state.user.username.id },
        });
    ...
    solveTime: function (flag) {
      try {
        ...
        if (
          now.getFullYear() == parseInt(flag.time.substr(0, 4)) &&
            ...
            for (let flag of res.data) {
              ...
              if (flag.have_read === true) {
                switch (flag.message_type) {
                  ...
                  case 10:
                    flag.message_a =
                      flag.sender_name + "给你分享了一篇文章，快去看看吧";
                    break;
                }
