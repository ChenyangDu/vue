                ...
                <el-col :span="23">
                  ...
                  <el-row>
                    ...
                    <el-col :span="8" align="center" v-if="!(id===creator.id)">
                      <div align="center">
                        <i
                          style="font-size: 55px; color: 0xFF0000"
      ...
      groupdocuments: [
        {
          id: 0,
          name: "",
          create_time: "2020-8-19T14:14",
          last_edit_time: "2020-8-19T14:14",
        },
      ],
      //团队id
      group_id: this.$route.params.group_id,
      //团队信息id、name、creator_id
      group_info: { id: 0, name: "蔡徐坤", creator_id: 0 },
      //团队成员
      group_member: [
        {
          id: 0,
